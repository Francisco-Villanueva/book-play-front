...
import { ChevronLeft, ChevronRight, LogOut, Repeat } from 'lucide-react'
    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-ink-25">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 pb-32">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 p-3.5 min-h-[52px] rounded-lg border border-ink-100 bg-white text-red-600 font-body font-bold text-body-sm cursor-pointer"
        >
